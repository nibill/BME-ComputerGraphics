...
mat4 ShadowViewer::m_constructLightViewMatrix(size_t li, size_t cube_face) const {
    ...
    **/
    ...
    vec3 pos = scene_view_matrix * m_light[li].position();
    ...
    return mat4::look_at(pos, pos + dir, up) * scene_view_matrix;
}
...
mat4 ShadowViewer::m_constructLightProjectionMatrix() const {
    ...
    **/
    ...
    return mat4::perspective(90, 1, 0.1f, 6);
}
...
void ShadowViewer::draw(const mat4 &view_matrix, const mat4 &projection_matrix) {
    ...
    mesh_n_matrix = inverse(transpose(mat3(mesh_mv_matrix)));
    plane_n_matrix = inverse(transpose(mat3(plane_mv_matrix)));
    ...
    for (size_t li = 0; li < m_numActiveLights; ++li) {
        ...
        **/
         ...
         **/
        vec3 l_col = vec3(m_light[li].color);
        vec3 l_pos = vec3(view_matrix * m_light[li].position());

        {
            ...
            m_phong_shader.set_uniform("light_color", l_col);
            m_phong_shader.set_uniform("light_position", l_pos);
